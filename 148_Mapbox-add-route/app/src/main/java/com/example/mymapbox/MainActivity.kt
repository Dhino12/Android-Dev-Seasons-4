            ...
            .getRoute(object : retrofit2.Callback<DirectionsResponse>{
                override fun onResponse(
                    ...
                    if(response.body() == null){
                        Toast.makeText(
                            this@MainActivity,
                            "Rute tidak ditemukan, pastikan Anda menyetel pengguna yang tepat dan token akses.",
                            Toast.LENGTH_SHORT
                        ).show()
                        return
                        ...
                        Toast.makeText(
                            this@MainActivity,
                            "Rute tidak ditemukan.", Toast.LENGTH_SHORT)
                            .show()
                        return
                    }
    ...
    private fun showNavigation(){
        btnNavigation.setOnClickListener{
            ...
            if(currentRoute != null){
                ...
                Toast.makeText(this, "currentRoute NULL",Toast.LENGTH_SHORT).show()
            }
        }
    }
