package com.example.cores.data.source.local

import com.example.cores.data.source.local.entity.TourismEntity
import com.example.cores.data.source.local.room.TourismDao
